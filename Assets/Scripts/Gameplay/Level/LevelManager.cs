...
//						AdsManager.Instance.ShowMopubAdOnLevelEnd ();
    ...
    public void LoadLevel(int LevelID)
    {
        ...
        if (GameManager.Instance.currentGameMode == GameManager.GameMode.SurvivalMode)
        {
            ...
            Camera.main.transform.position = CompleteAllLevels[24].Levels.transform.FindChild("StartCameraPosition").transform.position;
            Camera.main.transform.rotation = CompleteAllLevels[24].Levels.transform.FindChild("StartCameraPosition").transform.rotation;
        ...
        else if (GameManager.Instance.currentGameMode == GameManager.GameMode.CampaignMode)
        {
            ...
            Camera.main.transform.position = CompleteAllLevels[LevelID].Levels.transform.FindChild("StartCameraPosition").transform.position;
            Camera.main.transform.rotation = CompleteAllLevels[LevelID].Levels.transform.FindChild("StartCameraPosition").transform.rotation;
...
//		
        ...
        if (Constants.selectedLevel.Equals(3) || Constants.selectedLevel.Equals(7) || Constants.selectedLevel.Equals(15) || Constants.selectedLevel.Equals(23))
        {
            ...
            {
                if (transform.GetChild(Constants.selectedLevel).FindChild("BossPosition"))
                {
                    int rndm = Random.Range(0, Boss_list.Length);

                    GameObject Cheeta_Boss = (GameObject)Instantiate(Boss_list[rndm], transform.GetChild(Constants.selectedLevel).FindChild("BossPosition").transform.position, transform.GetChild(Constants.selectedLevel).FindChild("BossPosition").transform.rotation);
